...
public class LoginInterfaceProjeto extends javax.swing.JFrame {

 
    
    
    
    public LoginInterfaceProjeto() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginInterfaceProjeto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginInterfaceProjeto().setVisible(true);
            }
        });
    }
